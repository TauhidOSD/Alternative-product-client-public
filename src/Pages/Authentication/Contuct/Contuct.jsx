const Contuct = () => {
  return (
    <div>
      ...
      Need help or have questions? Contact us today via phone, email, or the contact form below. Our team is here to assist you with any inquiries you may have.
      </p>
    </div>
        </section>
          ...
          <div className=" container flex flex-col flex-1 px-6 py-12 mx-auto">
            <div className=" flex-1 lg:flex lg:items-center lg:-mx-6">
              <div className="text-white lg:w-1/2 lg:mx-6">
                ...
                Feel free to reach out to us for any inquiries or assistance. Whether you have questions about our services or need support with an existing order, our team is ready to help. Contact us via phone, email, or the contact form below. We look forward to hearing from you!
                </p>
