        ...
        <div className="container px-6 py-12 mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div className="flex justify-center items-center">
              <div>
              <a  href="#">
              <img className="w-auto h-28" src="https://i.postimg.cc/Vs0tw6m0/computer-and-laptop-repair-logo-template-icon-illustration-vector.jpg" alt="" />
             
            </a>
              </div>
              <div>
                <h1 className="md:text-2xl font-semibold">Contact</h1>
              </div>
            </div>
